var jsPlumbsetup = function (nodes, links,linklabels, csrftoken,allInputs,allOutputs, allIntermediates,model_id,editable) {
            ...
            dialogConfirm.dialog({
              ...
              buttons: {
                "Remove link": function() {
                  ...
                  $.post('/lcopt/removeLink/', postData);
        ...
        if(typeof labelText == 'undefined'){
          ...
          okButton.click(function(){
              ...
              postData = {
                ...
                'model_id': model_id,
                'input_code':jsPlumbUtil.uuid(),
                'output_code':jsPlumbUtil.uuid(),
                'csrfmiddlewaretoken': csrftoken,
              }

              console.log(postData);

                $.post('/lcopt/newConnection/', postData);
              ...
              $('#confirm_button').unbind().click(function(e){
                ...
                for(var i in thisConnectionsTo){
                  ...
                  if(intermediate == false && intNode == true){
                    ...
                    deleteDatabaseItem(conn.sourceId,csrftoken,thisType,model_id)
                ...
                for(var i in thisConnectionsFrom){
                  ...
                  if(intermediate == false  && intNode == true){
                    ...
                    deleteDatabaseItem(conn.targetId,csrftoken,thisType,model_id)
                ...
                deleteDatabaseItem(thisNodeID,csrftoken,thisNodeType,model_id);
              ...
              titleInput.keyup(function(e) {
                if (e.keyCode === 13) {
                  if (this.value == ""){
                    ...
                    console.log(postData);
                    $.post("/lcopt/renameProcess/", postData)
                }
                }
                if (e.keyCode === 27) {
                  $(this).parent().text(originalTitle);
    ...
    $('#addProcess').click(function(e){
      ...
      $('#confirm_button').unbind().click(function(e){
        code = jsPlumbUtil.uuid();
        createNewItem('process', $('#createItem').val(), "" ,csrftoken, model_id, code, 250, 250)
        var thisNode = newNodeExternal($('#createItem').val(),'transformation',code,250,250,instance);
        initNode(thisNode);
        $('#myModal').modal('hide');
      });
...
var deleteDatabaseItem = function(code,csrftoken,type,model_id){
  var postData = {
      'code': code,
      'csrfmiddlewaretoken': csrftoken,
      'type': type,
  ...
  $.post('/lcopt/deleteDatabaseItem/', postData);
};
...
createNewItem = function(type, name, unit ,csrftoken, model_id,code,x,y){
  ...
  var postData = {
   ...
   console.log(postData);
    ...
    $.post('/lcopt/newDatabaseItem/', postData, function(data){
       returnedData = data
    }, "json");
