function drawTree(data_path, parameter_set, method){
...
var htmlTest = `<foreignObject class="node" x="46" y="22" width="100" height="100">
        
            <div style="border:1px green solid">I'm a div inside a SVG.</div>                
    </foreignObject>
`
var htmlTest2 = '<div style = "border:1px green solid>Hello</div>'
...
d3.json(data_path, function(error, data) {
  ...
  var treeData = data[parameter_set][method].graph
