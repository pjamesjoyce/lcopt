    ...
    var formHtml = `
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-9">
                          <input class="form-control disabled" name = "extLink", id="extLink">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-xs-3">
                          <button type="button" id="search_button" type="submit" class="pull-right btn btn-primary">Search external databases</button>
                        </div>
                      </div>
                    </form>
                  `
    // create the modal
    var addInputModal = createModal(formTitle, formHtml)

    // append the modal to the document
    $(document.body).append(addInputModal);
